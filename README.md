...
| [`middleware`](#middleware) | Echo middlewares: auth check, error handler, request logger |
...
### 2. `CustomHTTPErrorHandler` — turns any error into clean JSON
...
### 3. `RequestLogger` — logs every request
